//! Domain policy for ItemVariant aggregate
//!
...
/// Domain policy for ItemVariant — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ItemVariant>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ItemVariantDomainPolicy = PermitAllPolicy<ItemVariant>;
