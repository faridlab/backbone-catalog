//! Domain policy for UomConversion aggregate
//!
...
/// Domain policy for UomConversion — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<UomConversion>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type UomConversionDomainPolicy = PermitAllPolicy<UomConversion>;
