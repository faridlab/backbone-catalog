//! Specifications for ItemGroup aggregate
//!
...
// Each predicate implements `Specification<ItemGroup>` and can be combined
...
//
// pub struct ActiveItemGroupSpec;
// impl Specification<ItemGroup> for ActiveItemGroupSpec {
//     fn is_satisfied_by(&self, e: &ItemGroup) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
