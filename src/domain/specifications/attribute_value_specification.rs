//! Specifications for AttributeValue aggregate
//!
...
// Each predicate implements `Specification<AttributeValue>` and can be combined
...
//
// pub struct ActiveAttributeValueSpec;
// impl Specification<AttributeValue> for ActiveAttributeValueSpec {
//     fn is_satisfied_by(&self, e: &AttributeValue) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
