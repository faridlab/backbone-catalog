//! Specifications for Brand aggregate
//!
...
// Each predicate implements `Specification<Brand>` and can be combined
...
//
// pub struct ActiveBrandSpec;
// impl Specification<Brand> for ActiveBrandSpec {
//     fn is_satisfied_by(&self, e: &Brand) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
