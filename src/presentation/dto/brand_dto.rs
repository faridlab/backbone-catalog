//! Brand DTOs (Data Transfer Objects)
//!
...
pub struct CreateBrandDto {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "short_description")]
    pub short_description: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 2000)))]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 500)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "logo_url")]
...
/// Request DTO for full update of a Brand
///
...
/// Request DTO for partial update of a Brand
///
...
pub struct PatchBrandDto {
    ...
    #[cfg_attr(feature = "validation", validate(length(max = 500)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "short_description")]
    pub short_description: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 2000)))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 500)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "logo_url")]
    pub logo_url: Option<String>,
    #[cfg_attr(feature = "openapi", schema(example = 42))]
...
/// Paginated list response for Brand entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct BrandListResponseDto {
    /// List of items
    pub items: Vec<BrandResponseDto>,
...
impl BrandListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<BrandResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Brand> for BrandSummaryDto {
    fn from(entity: Brand) -> Self {
...
impl From<CreateBrandDto> for Brand {
...
impl backbone_core::FromCreateDto<CreateBrandDto> for Brand {
    fn from_create_dto(dto: CreateBrandDto) -> backbone_core::ServiceResult<Self> {
        Ok(Brand::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to Brand here.
