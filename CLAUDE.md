...
│   └── dto/                              # internal application-layer DTOs (commands/queries)
│                                         #   NOTE: per-entity API request/response DTOs are
│                                         #   generated into presentation/dto/, not here
├── infrastructure/
│   ├── persistence/
...
│   │   └── mod.rs
│   ├── dto/                              # generated: Create/Update/Patch/Response/List/Summary
│   │   └── <entity>_dto.rs               #   per entity (the API contract; ToSchema for OpenAPI)
│   ├── middleware/
...
- DTOs (in `presentation/dto/<entity>_dto.rs`): `Create{Entity}Dto`, `Update{Entity}Dto`, `Patch{Entity}Dto`, `{Entity}ResponseDto`, `{Entity}ListResponseDto`, `{Entity}SummaryDto`.
