//! Uom API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the Uom CRUD API endpoints.
...
// ============================================================================
// UOM TEST DATA GENERATOR
// ============================================================================

/// Test data generator for Uom
pub struct UomTestData;

impl TestDataGenerator for UomTestData {
...
/// Uom API test suite
pub struct UomApiTest {
    inner: GenericCrudTest<UomTestData>,
}

impl UomApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/uoms", "Uom");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, UomTestData),
        }
    }
