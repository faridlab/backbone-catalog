...
--
-- This file contains initial seed data for the catalog.uoms table.
-- Customize this file to add your initial data.

-- INSERT INTO catalog.uoms (
--     id,
--     code,
--     name,
--     uom_type,
...
-- INSERT INTO catalog.uoms (id, code, name, is_active, created_at, updated_at) VALUES
